    ...
    <div className="h-[100dvh] w-full bg-[var(--color-bg)] flex flex-col font-[family-name:var(--font-corporate)] overflow-hidden relative">
      ...
      <header className="w-full bg-[var(--color-secondary)] text-white h-16 flex items-center justify-between px-4 sm:px-6 shrink-0 relative shadow-md">
        ...
        <div className="flex items-center gap-2 sm:gap-4 relative">
          ...
          <span className="hidden sm:block px-3 py-1.5 rounded-[var(--radius-sm)] text-[10px] sm:text-xs font-semibold border border-[var(--color-primary)]/30 text-[var(--color-primary-text)] bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary)]/80">Admin Portal</span>
            ...
            >
              ...
              {!isSidebarCollapsed && (
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-slate-400 truncate font-semibold">Admin profile</p>
                </div>
              )}
              {isSidebarCollapsed && (
            ...
            <div className="overflow-y-auto p-5 sm:p-6 space-y-5 sm:space-y-6 custom-scrollbar pb-8 sm:pb-6">
              ...
              <div className="bg-[var(--color-secondary)] rounded-[1.5rem] sm:rounded-[var(--radius-xl)] p-5 sm:p-6 text-white flex flex-col items-center text-center gap-3 relative overflow-hidden shadow-lg shrink-0">
                ...
                <div className="z-10 mt-1 min-w-0 w-full px-2">
                  ...
                  <p className="text-[10px] sm:text-xs font-bold text-white/70 mt-1 tracking-widest uppercase">System Administrator</p>
                </div>
              </div>
            ...
            <div className="overflow-y-auto bg-[var(--color-bg)] custom-scrollbar flex-1 pb-8 sm:pb-0">
              ...
              <div className="bg-[var(--color-secondary)] px-5 sm:px-8 py-6 sm:py-8 flex flex-col sm:flex-row items-center sm:items-center gap-4 sm:gap-6 relative shrink-0 text-center sm:text-left">
                ...
                <div className="relative group w-20 h-20 sm:w-24 sm:h-24 shrink-0 z-10">
                  <div className="w-full h-full rounded-2xl border-[3px] border-white bg-white flex items-center justify-center overflow-hidden relative shadow-[var(--shadow-md)]">
                    {orgData?.logo_url ? (
                  ...
                  {isUploadingLogo && (
                    <div className="absolute -bottom-5 left-0 right-0 text-center">
                      <p className="text-[8px] sm:text-[9px] font-bold uppercase tracking-wider text-white/80 animate-pulse">Uploading...</p>
                    </div>
                  )}
                </div>
                ...
                <div className="text-center sm:text-left text-white flex-1 min-w-0 z-10 w-full">
                  ...
                  <p className="text-white/70 text-xs font-semibold flex items-center justify-center sm:justify-start gap-1.5">
                      ...
                      {orgData ? (
                        ...
                        <div className="col-span-1 sm:col-span-2 text-center text-slate-400 text-xs py-8">
                          <div className="animate-pulse flex flex-col items-center gap-2.5">
                            <div className="w-6 h-6 border-3 border-[var(--color-border)] border-t-[var(--color-primary)] rounded-full animate-spin"></div>
          ...
          <div className="bg-white rounded-[1.5rem] sm:rounded-[2rem] shadow-2xl w-full max-w-sm overflow-hidden text-center p-6 sm:p-8 transform transition-all animate-in zoom-in-95 duration-500 border border-[var(--color-border)]">
            ...
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="flex-1 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white py-3 sm:py-3.5 rounded-[var(--radius-md)] text-sm sm:text-sm font-black transition-all shadow-lg shadow-red-500/25 active:scale-[0.96]"
              >
                Log Out
              </button>
            </div>
  ...
  return (
    <div className="relative group/navitem">
      ...
      >
        ...
        {!collapsed && (
          <>
            <span className="tracking-wide truncate whitespace-nowrap flex-1 text-left pr-4">{label}</span>
