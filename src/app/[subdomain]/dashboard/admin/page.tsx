    ...
    <div className="h-[100dvh] w-full bg-[var(--color-bg)] flex flex-col font-[family-name:var(--font-corporate)] overflow-hidden relative">
      ...
      <header className="w-full bg-[var(--color-secondary)] text-white h-16 flex items-center justify-between px-4 sm:px-6 shrink-0 relative shadow-md">
        ...
        <div className="flex items-center gap-2 sm:gap-4 relative">
          ...
          <span className="hidden sm:block px-3 py-1.5 rounded-[var(--radius-sm)] text-[12px] sm:text-xs font-extrabold border border-[var(--color-primary)]/30 text-[var(--color-primary-text)] bg-[var(--color-primary)]">Admin Portal</span>
            ...
            >
              ...
              {!isSidebarCollapsed && (
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-extrabold text-white truncate">{adminProfile.name}</p>
                  <p className="text-[10px] text-slate-400 truncate font-extrabold">ADMIN PROFILE</p>
                </div>
              )}
              {isSidebarCollapsed && (
